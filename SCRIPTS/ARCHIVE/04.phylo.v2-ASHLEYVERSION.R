...
all.prairie.small <- all.prairie.mean[c('pNDVIvalues', 'pNDVI.block.resid')] ##calibrated NDVI
names(all.prairie.small) <- c('NDVI', 'NDVI.resid')
...
tr.prairie.biomass.K <- list(
                NDVI = phylosignal(all.prairie.small[tr.prairie.phylosig$tip.label, 'NDVI'], tr.prairie.phylosig)[1,],
                NDVI Residuals = phylosignal(all.prairie.small[tr.prairie.phylosig$tip.label, 'NDVI.resid'], tr.prairie.phylosig)[1,]
              )
